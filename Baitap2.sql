...
ON PRIMARY
(NAME = MOVIES2_data, FILENAME = 'D:\CSDL\BTTH T2-3\MOVIES2_data.mdf', SIZE = 25MB, MAXSIZE = 40MB, FILEGROWTH = 1MB)
LOG ON
(NAME = MOVIES2_log, FILENAME = 'D:\CSDL\BTTH T2-3\MOVIES2_log.ldf', SIZE = 6MB, MAXSIZE = 8MB, FILEGROWTH = 1MB);
ALTER DATABASE MOVIES2 ADD FILE ( NAME = MOVIES_data2, FILENAME = 'D:\CSDL\BTTH T2-3\MOVIES2_data2.ndf', SIZE = 10MB);
ALTER DATABASE MOVIES SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
SELECT name, user_access_desc FROM sys.databases WHERE name = 'MOVIES2';
...
--- KIEM TRA LAI
SELECT name, user_access_desc FROM sys.databases WHERE name = 'MOVIES2';
ALTER DATABASE MOVIES2 MODIFY FILE (NAME = MOVIES_data2, SIZE = 15MB);
--- KIEM TRA DU LIEU
EXEC sp_helpdb MOVIES2;
--- CHUYEN VE AUTO SHRINK
ALTER DATABASE MOVIES SET AUTO_SHRINK ON;
SELECT name, is_auto_shrink_on FROM sys.databases WHERE name = 'MOVIES2';
--- PHAT SINH SCRIPTS: 
CREATE DATABASE [MOVIES2]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MOVIES1', FILENAME = N'D:\CSDL\BTTH T2-3\MOVIES1.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'MOVIES1_log', FILENAME = N'D:\CSDL\BTTH T2-3\MOVIES1_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
---3:
ALTER DATABASE MOVIES2 ADD FILEGROUP DATA;
ALTER DATABASE MOVIES2 MODIFY FILE ( NAME = MOVIES2_log, MAXSIZE = 10MB);
ALTER DATABASE MOVIES2 MODIFY FILE (NAME = MOVIES_data2, SIZE = 10MB);
ALTER DATABASE MOVIES2 MODIFY FILE (NAME = MOVIES2_data2, FILEGROUP = DATA);
EXEC sp_helpDB MOVIES2;
--- 4
--- 
---5
...
( NAME = N'MOVIES1', FILENAME = N'D:\CSDL\BTTH T2-3\MOVIES1.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'MOVIES1_log', FILENAME = N'D:\CSDL\BTTH T2-3\MOVIES1_log.ldf' , SIZE = 1024KB , MAXSIZE = 10240KB , FILEGROWTH = 10%)
GO
